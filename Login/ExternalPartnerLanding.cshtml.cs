...
{
    public class ExternalPartnerLandingModel : PageModel
    {
        public IActionResult OnGet()
        {
            ...
            ViewData["LoginMessage"] = $"Login for {userEmail} successful! You have External Partner permissions.";
            return Page();
        }
    }
}
